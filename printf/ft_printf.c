...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/14 17:24:22 by jmoulin           #+#    #+#             */
/*   Updated: 2023/11/14 17:24:22 by jmoulin          ###   ########.ch       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_parse_format(const char *format, int i, struct s_vars *v)
{
	if (format[i] == 'c')
...
void	ft_parse(const char *format, int i, struct s_vars *v)
{
	while (format[i])
	{
		...
		{
			i++;
			v->count += ft_parse_format(format, i, v);
		}
		else
		{
			ft_putchar(format[i]);
